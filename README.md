...
* "phase shift i" refers to the phase shift between the periodic artifact in the 0th segment and the ith segment of the observed signal and corresponds to the ith gap in the data.
